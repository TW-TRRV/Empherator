...
<div class="min-h-screen bg-obscure-darker font-sans text-clarity-lighter flex flex-col">
    ...
    <main class="flex-1 w-full px-4 md:px-6 py-12">
        ...
        <section class="grid grid-cols-1 md:grid-cols-3 gap-4 px-2"> 
            ...
            <div class="bg-obscure-lightest flex flex-col border border-obscure-lightest hover:border-emph transition-all duration-300 group">
                ...
                <div class="aspect-video w-full bg-black flex items-center justify-center p-12 overflow-hidden">
                ...
                <div class="p-4 bg-obscure-light flex-1">
                    <div class="flex justify-between items-start mb-8">
                        ...
                        <span class="text-3xl font-black text-white">
                            ${{ number_format(str_replace(['$', ','], '', $product['price']), 0) }}
                        </span>
                    </div>

                    <div class="flex gap-2">
                        <button class="flex-1 bg-emph hover:bg-emph-dark text-white text-xs font-black tracking-[0.2em] h-14 transition-all uppercase">
                            Buy Now
                        </button>
