    ...
    <main class="flex-1 flex items-center justify-center w-full py-32">
        <div class="w-full max-w-md bg-obscure-lighter border border-obscure-lightest p-10 flex flex-col items-center mx-4 shadow-2xl">
            ...
            <div class="w-full text-left mb-8 border-l-2 border-emph pl-4">
                <h1 class="text-xl font-bold tracking-widest text-clarity-lighter mb-1 uppercase">System Access</h1>
                <p class="text-[10px] text-clarity font-bold uppercase tracking-widest opacity-70">New Era Operational Interface</p>
            </div>
            ...
            <form class="w-full" action="{{ route('login') }}" method="POST">
                ...
                {{-- Password --}}
                <div class="mb-8">
                    <label class="block text-[10px] font-bold text-clarity mb-2 uppercase tracking-widest">Security Key</label>
                    <input
                        type="password"
                        name="password"
                        placeholder="********"
            ...
            {{-- Footer Links del Formulario --}}
            <div class="flex flex-col gap-3 items-center">
                <a href="{{ route('password.request') }}" class="text-[9px] text-clarity hover:text-emph-light uppercase tracking-widest transition-all duration-300">
                    System Locked? Request Reset
                </a>
                
                <div class="h-px w-8 bg-obscure-lightest my-1"></div>

                <a href="{{ route('register') }}" class="text-[10px] font-bold text-emph-lighter hover:text-emph transition-all duration-300 uppercase tracking-[0.2em]">
